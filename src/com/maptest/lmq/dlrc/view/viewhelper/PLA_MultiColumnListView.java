 ...
 * @date 2012-11-06
 */
public class PLA_MultiColumnListView extends PLA_ListView
{
	...
	public PLA_MultiColumnListView(Context context)
	{
		super(context);
		init(null);
	}

	public PLA_MultiColumnListView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init(attrs);
	}
	...
	private void init(AttributeSet attrs)
	{
		...
		} else
		{
			...
			int defColNumber = a.getInteger(
					R.styleable.PinterestLikeAdapterView_plaColumnNumber, 2);
