...
public abstract class PLA_AdapterView<T extends Adapter> extends ViewGroup
{
	...
	public interface OnItemClickListener
	{
		 ...
		 */
		void onItemClick(PLA_AdapterView<?> parent, View view, int position,
				long id);
	}
	...
	public interface OnItemLongClickListener
	{
		 ...
		 */
		boolean onItemLongClick(PLA_AdapterView<?> parent, View view,
	...
	public interface OnItemSelectedListener
	{
		 ...
		 */
		void onItemSelected(PLA_AdapterView<?> parent, View view, int position,
				long id);
