 ...
 */
public class PLA_HeaderViewListAdapter implements WrapperListAdapter,
		Filterable
{
	...
	static final ArrayList<PLA_ListView.FixedViewInfo> EMPTY_INFO_LIST = new ArrayList<PLA_ListView.FixedViewInfo>();

	boolean mAreAllFixedViewsSelectable;

	private final boolean mIsFilterable;

	public PLA_HeaderViewListAdapter(
			ArrayList<PLA_ListView.FixedViewInfo> headerViewInfos,
	...
	private boolean areAllListInfosSelectable(
			ArrayList<PLA_ListView.FixedViewInfo> infos)
	{
		if (infos != null)
		{
